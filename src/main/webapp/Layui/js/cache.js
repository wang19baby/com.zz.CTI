...
layui.use(['form','jquery',"layer"],function() {
    ...
    function lockPage(){
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                            '<div class="admin-header-lock-img"><img src="/' + WEB_NAME + '/Layui/images/face.jpg" class="userAvatar"/></div>'+
                            '<div class="admin-header-lock-name" id="lockUserName">' + $(".name").text() + '</div>'+
                            '<div class="input_btn">'+
    ...
    $('.agentGroupList').click(function(){
    	layer.open({
            ...
            id: 'LAY_agentGroupList', 	// 用于控制弹层唯一标识
            moveType: 1,
            content: ['/' + WEB_NAME + '/page/agentGroupList', 'no'],
