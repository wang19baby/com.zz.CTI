...
layui.use(['request','form','layer','laydate','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        elem: '#agentByGroup', //指定原始表格元素选择器（推荐id选择器）
    ...
    //列表操作
    table.on('tool(agentByGroup)', function(obj){  //注：tool是工具条事件名，newsList是table原始容器的属性 lay-filter="对应的值"
