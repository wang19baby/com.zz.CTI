...
<form class="layui-form">
	<table id="agentGroupList" lay-filter="agentGroupList"></table>
	...
	<script type="text/html" id="agentListBar">
		<a class="layui-btn layui-btn-xs layui-btn-primary" lay-event="look">查看<span class="layui-badge-dot"></span></a>
		<a class="layui-btn layui-btn-xs" lay-event="call">呼叫</a>
	</script>
</form>
	<script type="text/javascript" src="${ctxStatic}/Layui/layui/layui.js"></script>
	<script type="text/javascript" src="${ctxStatic}/Layui/js/agentGroup/agentGroupList.js"></script>
</body>
</html>