...
<body class="childrenBody">
	<blockquote class="layui-elem-quote layui-bg-green">
		<div id="nowTime" data-name=<shiro:principal property="name"/>></div>
	</blockquote>
	<div class="layui-row layui-col-space10 panel_box">
		<!-- 语音通话 -->
		<div class="panel layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg2">
			<a href="javascript:;" data-url="${ctx}/page/callOut">
				<div class="panel_icon layui-bg-green">
					<i class="layui-anim seraph layui-icon">&#xe63b;</i>
				</div>
		...
		<!-- 录音 -->
		<div class="panel layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg2">
			<a href="javascript:;" data-url="${ctx}/page/recordList">
		...
		<div class="panel layui-col-xs12 layui-col-sm6 layui-col-md4 layui-col-lg2">
			<a href="javascript:;">
				<div id="statusDiv" class="panel_icon layui-bg-cyan">
					<i class="layui-anim layui-icon">&#xe612;</i>
				</div>
				<div class="panel_word">
					<span id="statusSpan">签出</span>
					<cite>坐席状态</cite>
				</div>
			</a>
		</div>
	...
	<blockquote class="layui-elem-quote main_btn">近五条通话记录</blockquote>
	<!-- 坐席当日统计信息 -->
	<div class="layui-row layui-col-space10">
		<div class="layui-col-lg6 layui-col-md12">
			<blockquote class="layui-elem-quote title">坐席当日统计信息</blockquote>
			<table class="layui-table magt0">
				...
				<tr>
					<td>总通时</td>
					<td class="talktime"></td>
				</tr>
				<tr>
					<td>接听次数</td>
					<td class="answernums"></td>
				</tr>
				<tr>
					<td>久不应答次数</td>
					<td class="noanswernums"></td>
				</tr>
				<tr>
					<td>外呼次数</td>
					<td class="calloutnums"></td>
				</tr>
				<tr>
					<td>内部呼叫次数</td>
					<td class="intercallnums"></td>
				</tr>
				<tr>
					<td>转接次数</td>
					<td class="transfernums"></td>
				</tr>
				<tr>
					<td>转出次数</td>
					<td class="transferoutnums"></td>
				</tr>
				<tr>
					<td>保持次数</td>
					<td class="keepnums"></td>
				</tr>
				<tr>
					<td>示忙次数</td>
					<td class="busynums"></td>
				</tr>
				<tr>
					<td>示忙时长</td>
	...
	<script type="text/javascript" src="${ctxStatic}/Layui/js/main.js"></script>
</body>
</html>